...
mysqli_query($db, "INSERT INTO `add_student`(`std_name`, `gender`, `dob`, `course`, `year`, `email`, `password`, `image`) 
VALUES ('$_POST[std_name]', '$_POST[gender]', '$_POST[birth_date]', '$_POST[course]', '$_POST[year_lvl]', '$_POST[email_id]', '$_POST[password]', 'default.jpg')");
    ?>
        <script type="text/javascript">
